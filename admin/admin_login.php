...
<body>
  ...
  <section class="bg-white">
    <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
      ...
      <form action="login.php" method="POST" class="w-full max-w-md" autocomplete="off">
        ...
        <div class="relative flex items-center mt-8 mb-4">
          ...
          <input type="text" id="username" name="username" class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Username" required>
        </div>
        ...
        <div class="mt-6">
          <input type="submit" class="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-800 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50" value="Sign in" />
